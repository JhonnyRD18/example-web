       ...
       <div className="container cuerpo mt-4 mb-4">
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            ...
            <svg className="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="" role="img" aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false">
              <title>Placeholder</title><image href="imagen1.jpg" width="100%" height="100%"/></svg>
